...
# Correlation $\neq$ Causation
Linear regression models assess the degree of correlation between two or more variables. However, just because two variables are correlated, does not mean one is necessarily caused by the other. This can happen in three primary ways: reverse causation, confounding factors, and spurious correlation. 
