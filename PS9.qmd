...
2. Compare the correlation coefficients ($r$) for every independent variable paired with your dependent variable.
   A. Which has the highest correlation?
   B. Is that the same variable you used in your linear model? If not, create another linear model using the variable with the highest correlation. 
