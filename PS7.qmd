...
ax3.hist(sales17.price, bins=30)
ax3.set_title("Figure 3. Histogram of Home Sales Prices in New England (Right Skewed)")
...
ax4[1].hist(sales17.price, bins=30)
ax4[1].set_title("Figure 3. Histogram of Home Sales Prices in New England (Right Skewed)")
