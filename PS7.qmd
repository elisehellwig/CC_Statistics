...
ax1.set_title("Figure 1. Data Distribution of Rolling a 6-sided Die 10,000 times\n(Frequency)")
...
ax2.set_ylim([0,1])
ax2.set_title("Figure 2. Data Distribution of Rolling a 6-sided Die 10,000 times\n(Probability)")
