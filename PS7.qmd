...
def CalcStats(v, digits=2, bins=30):
    # Calculates mean, median, mode and standard dev of vector v
    # if v is an integer vector, statistics.mode is used, otherwise 
    ...
    #if v is an integer vector use regular mode
    if isinstance(v[0], np.int64) or isinstance(v[0], int) :
        d['mode'] = mode(v)
