...
mu_price = np.mean(sales17.price)
med_price = np.median(sales17.price)
mode_price = st.mode(sales17.price)
sig_price = np.std(sales17.price)

norm_price = rng.normal(loc=mu_price, scale=sig_price)
...
ax4[1].hist(price17_2M, bins=40)
ax4[1].axvline(x=mu_price, color = 'black', linestyle='dashed')
...
ax4[1].set_ylabel('Number of Houses')
fig4.suptitle('Figure 4. Mean, Median, and Mode for Symetric and Skewed Distributions', fontsize=16)
plt.show()
