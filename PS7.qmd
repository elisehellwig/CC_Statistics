...
fig4, ax4 = plt.subplots(nrows=2, sharex=True, figsize=(8, 6))
...
fig4.suptitle('Figure 4. Mean, Median, and Mode for Skewed and Symmetric\n Distributions of 2017 Home Sales in New England', fontsize=16)

plt.subplots_adjust(hspace=0, top=0.9, bottom=0.17)
