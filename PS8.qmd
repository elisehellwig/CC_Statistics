...
df['Y1'] = df.X*1/2 + rand.uniform(-0.1, 0.1, n_rand)
df['Y2'] = df.X*1/2 + rand.uniform(-1, 1, n_rand)
df['Y3'] = df.X*2 + rand.uniform(-0.1, 0.1, n_rand)
df['Y4'] = df.X*2 + rand.uniform(-1, 1, n_rand)

titles = ['High Correlation']
